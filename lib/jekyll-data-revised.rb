...
Jekyll::Hooks.register :site, :after_reset do |site|
  if site.theme
    ...
    JekyllDataRevised::ThemeConfiguration.reconfigure(site) if File.exist?(file)
  else
...
# ---------------------------------------------------------------------------
# Replace Jekyll::Reader with a subclass JekyllDataRevised::Reader only if the
...
Jekyll::Hooks.register :site, :after_init do |site|
  if site.theme
    ...
    site.reader = JekyllDataRevised::Reader.new(site)
  end
end
